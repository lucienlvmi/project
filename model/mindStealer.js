...
[
    { description: " a. Dr. Thomas Harvey", scene: "decide_to_visit_Harvey"},
    { description: " b. Dr. Marian Diamond in UC Berkeley", scene: "decide_to_visit_Diamond"},
    { description: " c. Dr. Sandra Witelson", scene: "decide_to_visit_Witelson"},
    { description: " d. Dr. Britt Anderson", scene: "decide_to_visit_Anderson"}
])
...
[
    { description: "a. Pretend to be a local reporter", scene: "pretend_reporter"},
    { description: "b. Pretend to be a plumber", scene: "pretend_plumber"} 
])
...
What will you do?`, 
[
    { description: "a. Do not touch anything in the basement. Go upstairs in the kitchen and grab something to eat and wait for the Doctor. He said not to touch anything.", scene: "wait_eat"},
    { description: "b. Check if the Doctor is really out and start snooping. You have limited time and he said he have some important stuffs down here.", scene: "snoop_around"} 
])
...
What to do first?`,
[
    { description: "a. Read the New Jersey Monthly  ", scene: "read_newspaper"},
